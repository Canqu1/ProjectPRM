...
public class SaleFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        eventList.add(new Event("Statue painting ", "room1", des1));
        eventList.add(new Event("Movie night", "room2", des2));
        eventList.add(new Event("Therapy advice ", "room3", des3));
        eventList.add(new Event("Diet Activity", "room4", des4));
        eventList.add(new Event("Book talk", "room5", des5));
